...
class TransactionsModel(models.Model):
    ...
    sender=models.ForeignKey('accounts.AccountModel', on_delete=models.CASCADE,  related_name='sent_transactions', null=True, blank=True )
    receiver=models.ForeignKey('accounts.AccountModel', on_delete=models.CASCADE,  related_name='received_transactions', null=True, blank=True )
